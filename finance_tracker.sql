...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2024 at 11:03 PM
...
(1, 'zevan', 'admin', 'testemail@email.com'),
(2, 'zevan', 'admin', 'testemail@email.com');
...
--
ALTER TABLE `budgets`
  MODIFY `budget_id` int(1) NOT NULL AUTO_INCREMENT;
